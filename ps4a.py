...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(local_hand):
        print 'Current Hand:  ',
        ...
        if user_input == '.':
            ...
            print ' points.'
            return
        if not isValidWord(user_input, local_hand, wordList):
            print 'Invalid word, please try again.'
            print
        else:
            thisscore = getWordScore(user_input, n)
            ...
            print totalscore,
            print ' points\n'
            local_hand = updateHand(local_hand, user_input)
